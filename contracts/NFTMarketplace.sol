...
contract NFTMarketplace {
  ...
  function makeOffer(uint _id, uint _price) public {//_id is the NFT ID, price is the price in ETH
    nftCollection.transferFrom(msg.sender, address(this), _id);// Transfer the NFT to the marketplace
    offerCount ++;
