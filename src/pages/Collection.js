...
export default function Collection() {
  ...
  const [ selector, setSelector ] = React.useState(0); // 0: all, 1: mine, 2: on sale
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Divider sx={{ gap: 2, my: 2 ,'--Divider-childPosition': { lg: `70%`, xs: `50%` } }}>
          <Chip onClick={() => setSelector(0)} variant="soft" color="neutral" size="sm">
            show all
          </Chip>
          <Chip onClick={() => setSelector(1)} variant="soft" color="neutral" size="sm">
            mine
          </Chip>
          <Chip onClick={() => setSelector(2)} variant="soft" color="success" size="sm">
            on sale
          </Chip>
        </Divider>
        ...
        >
          ...
          {collectionCtx.collection.map((NFT, key) => {
            ...
            if ( selector == 0 ? 1 : selector==1 ? owner == web3Ctx.account : price !== null ) {
            return (
              <Card key={key} 
                sx={{ 
                width: 300, 
